...
public class ActivityLinkCollector extends AppCompatActivity {
    ...
    private ArrayList<ListItems> itemList = new ArrayList<>();
    ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                Toast.makeText(ActivityLinkCollector.this, "Delete an item", Toast.LENGTH_SHORT).show();
    ...
    private void initialItemData(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(NUMBER_OF_ITEMS)) {
            if (itemList == null || itemList.size() == 0) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    ListItems itemCard = new ListItems(imgId, itemName, itemDesc, isChecked);
        ...
        // The first time to opne this Activity
            ...
            ListItems item1 = new ListItems(R.drawable.pic_gmail_01, "Gmail", "Example description", false);
            ListItems item2 = new ListItems(R.drawable.pic_google_01, "Google", "Example description", false);
            ListItems item3 = new ListItems(R.drawable.pic_youtube_01, "Youtube", "Example description", false);
            itemList.add(item1);
            itemList.add(item2);
            itemList.add(item3);
        }
    ...
    private void createRecyclerView() {
        ...
        rviewAdapter = new RecyclerViewAdapter(itemList);
    ...
    private void addItem(int position) {
        itemList.add(position, new ListItems(R.drawable.empty, "No Logo item", "Item id: " + Math.abs(new Random().nextInt(100000)), false));
        Toast.makeText(ActivityLinkCollector.this, "Add an item", Toast.LENGTH_SHORT).show();
